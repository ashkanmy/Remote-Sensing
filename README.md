...
corresponding to the shown middle image are once again presented in (Right). One observes a light blue strip with relatively lower 
values within the band to appear on costal area adjacent to the clouded part.
